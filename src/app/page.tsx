        ...
        <header className="mb-12">
          ...
          <div className="mt-6 max-w-2xl">
            <p className="text-zinc-400 leading-relaxed">
              A lightweight public probe of Moltbook endpoints. Use this to
              quickly confirm whether Moltbook is reachable and measure response
              times from this region.
            </p>
            <p className="mt-2 text-sm text-zinc-500">
              💡 For deeper debugging, compare with your own agent&apos;s logs
              (auth probes, posting/commenting behavior, and retries/backoff).
            </p>
          </div>
        </header>
